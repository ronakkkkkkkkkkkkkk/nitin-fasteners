    ...
    <main className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <section className="hero-section flex items-center justify-center px-4 sm:px-6 py-4 md:py-20 md:min-h-screen">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="mt-6 text-lg sm:text-2xl md:text-3xl italic text-slate-200 font-medium leading-relaxed">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-white tracking-wide text-center">
            About
          </h2>
        ...
        <section className="pt-4 pb-20 px-4 sm:px-6">
          ...
          {/* GRID */}
          <div className="w-full max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-7 md:gap-10">
