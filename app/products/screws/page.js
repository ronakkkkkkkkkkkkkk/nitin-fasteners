  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div
        ...
        "
        style={{
          backgroundImage: "url('/screws.webp')",
      ...
      >
        ...
        >
          ...
          in various sizes, thread types, materials, and finishes.
          Designed for precision fastening, secure grip, corrosion
          resistance, and long-term durability, our screws are ideal for
          industrial and commercial fastening requirements.
        </p>
